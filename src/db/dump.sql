...
--
-- Name: urls shortUrl_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.urls
    ADD CONSTRAINT "shortUrl_unique" UNIQUE ("shortUrl");
...
GRANT ALL ON SCHEMA public TO shortly_drfw_user;
